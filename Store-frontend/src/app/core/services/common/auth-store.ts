...
import { AccessTokenClaims, AuthSession } from '@app/core/models/interfaces/auth-session';
import { readAccessToken } from '@app/core/utils/jwt';
...
/**
 * Holds the signed-in session as signals and mirrors it to `localStorage`.
 * Root-scoped: the header, the interceptor and the catalogue all read it.
 */
